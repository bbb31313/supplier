  ...
  <script type="text/javascript">
      ...
      var grid = $("#maingrid").ligerGrid({
          columns: 
                [
					...
					{display:"合同应交月份",name:"accountmonth", width: 90},
					...
					{display:"合计",name:"summoney", width: 90}
                 ], 
           dataAction: 'server',
 		   url: rootPath + 'wyrpt/rpt_getClassList.action?view=RptOverPay',
           sortName: 'zlcode', 
           pageSize: 20, 
           //toolbar: {},
      ...
      $("#formsearch").ligerForm({
		   fields:[
		    ...
		    {display:"查询日期",name:"accountdate",newline:true,labelWidth:100,width:220,space:30,type:"date",cssClass:"field",attr: { "op": "lessorequal"}},
