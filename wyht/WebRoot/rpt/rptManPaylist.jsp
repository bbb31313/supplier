      ...
      var grid = $("#maingrid").ligerGrid({
          columns: 
                [
                   	...
                   	{display: "所缴月份", name: "paidmonth", width: 120 },
				   	{display: "收款日期", name: "paydate", width: 90},
				   	{display: "收款单号", name: "payid", width: 90},
					{display:"收款人姓名",name:"payman", width: 90},
					...
					{display:"交款方式",name:"paymode", width: 90},
					{display:"物业管理费金额",name:"wymoney", width: 90},
					{display:"空调用费金额",name:"ktmoney", width: 90},
					{display:"滞纳金（不含减免金额）",name:"znjmoney", width: 160},
					{display:"金额合计",name:"summoney", width: 90}
                 ], 
           dataAction: 'server',
 		   url: rootPath + 'wyrpt/rpt_getClassList.action?view=RptManPay',
           sortName: 'entrydate', 
           pageSize: 20, 
           //toolbar: {},
